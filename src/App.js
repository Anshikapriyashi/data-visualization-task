  ...
  return (
    ...
    <h1 className="chart-heading">Line Chart</h1>
      <ResponsiveContainer width="100%" aspect={3}>
        <LineChart data={winedata} width={500} height={300} margin={{ top: 5, right: 300, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" />
          <XAxis dataKey="Flavanoids" interval={'preserveStartEnd'}/>
          <YAxis dataKey="Ash" interval={'preserveStartEnd'}/>
          <Tooltip contentStyle={{ backgroundColor: 'yellow' }} />
          <Legend />
          <Line type="monotone" dataKey="Flavanoids" stroke="green" activeDot={{ r: 8 }} />
